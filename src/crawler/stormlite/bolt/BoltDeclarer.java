...
import crawler.stormlite.routers.FieldBased;
import crawler.stormlite.routers.First;
import crawler.stormlite.routers.RoundRobin;
import crawler.stormlite.routers.StreamRouter;
import crawler.stormlite.tuple.Fields;

/**
 * This determines how we route messages to the next operator, e.g.,
...
public class BoltDeclarer implements Serializable {
    ...
    /**
     * If we have field-based grouping, we need to know the fields used to shard
     * the data
     * 
     * @return
     */
     ...
     *            The stream name
     * @param fields
     *            The fields to group and shard by
     */
    ...
    /**
     * Creates (or returns) a "router" that funnels our output stream to the
     * next destination (which might have multiple executors).
     * 
     * @return
     */
