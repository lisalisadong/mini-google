 ...
 */
package crawler.stormlite.routers;
...
import crawler.stormlite.spout.FileSpout;
...
//			if(bolt.getClass().getName()
//					.equals("edu.upenn.cis.stormlite.bolt.MapBolt")) 
//			{
//				System.out.println("Task queued: "
//						+ bolt.getClass().getName() + " (" + bolt.getExecutorId() + "): (EOS)");
//			}
	...
	public synchronized void executeEndOfStreamLocally(TopologyContext context) {
		for (IRichBolt bolt: getBolts())
			if (!isRemoteBolt(bolt)) {
				log.debug("Task queued from other worker: " + bolt.getClass().getName() + " (" + bolt.getExecutorId() + "): (Local EOS)");
//				
//				if(bolt.getClass().getName()
//						.equals("edu.upenn.cis.stormlite.bolt.MapBolt")) 
//				{
//					System.out.println("Task queued from other worker: " 
//							+ bolt.getClass().getName() + " (" + bolt.getExecutorId() + "): (Local EOS)");
//				}
				context.addStreamTask(new BoltTask(bolt, Tuple.getEndOfStream()));
			}
	}
